...
\inputresults{../analytical_exact/sediment_settling}
\inputresults{../analytical_exact/sediment_erosion}
\inputresults{../analytical_exact/sediment_settling_basin}
\inputresults{../analytical_exact/sediment_equilibrium_flow}
\inputresults{../analytical_exact/sediment_bed_hump}
...
\inputresults{../experimental_data/van_rijn_pickup_flume}
\inputresults{../experimental_data/van_rijn_trench}
\inputresults{../experimental_data/wang_ribberink_settling}
\inputresults{../experimental_data/zaragoza_pier_dambreak}
