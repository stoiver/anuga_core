...
holding the whole 24~cm channel at about 25 cells across, 8~mm over the
sand and 6~mm around the pier, on a coarser reservoir; it releases the
...
\end{center}
\caption{The mesh: the whole flume is held at about 25 cells across its
24~cm width, 8~mm over the erodible sand and 6~mm around the pier, which is
cut out as a hole with reflective edges; the reservoir, where the flow is a
slow drawdown, takes the overall cap of 26~mm. The reservoir and the flume are one
...
below the model gives 5.0 and 9.8, and without it 2.9 and 6.0. The deepest
points are 32 and 53~mm measured against 20 and 21 (the 53 exceeds the
sand thickness and is a Kinect artefact at the pier's edge), and the wake
deposit overshoots, +6.1 and +7.4 against +3.0 and +2.4, which is the cost
