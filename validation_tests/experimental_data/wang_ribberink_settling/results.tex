...
\hline
measured & 1.44, 1.55 & & & \\
instantaneous exchange [D-1] & 2.99 & 0.73 & 0.58 & $-0.52$, $-0.38$ \\
carried near-bed ratio [D-4] & 2.99 & 0.73 & 0.58 & $-0.52$, $-0.38$ \\
Galappatti lag [D-3] & 1.49 & 0.24 & 0.34 & $+0.21$, $+0.31$ \\
\textbf{two-layer, velocity split [D-5]} & \textbf{1.50} & \textbf{0.11} & \textbf{0.08} & $-0.03$, $+0.07$ \\
\hline
\end{tabular}
\end{center}
...
decays at 1.50. The case runs with it and requires
