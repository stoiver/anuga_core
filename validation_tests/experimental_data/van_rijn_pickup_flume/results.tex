...
the flume. With the de Leeuw law the ratios are 0.74, 0.66, 0.57 and 0.46
(mean 0.60); van Rijn's own SUTRENCH model reaches 0.68 of the measurement
at $x = 40d$. The Smith--McLean law with its default reference level of
...
Note that a depth-averaged model adapts over the settling length
$q/(d^{*} w_s)$, whereas the measured load was still rising at $x = 40d$
because of the slow diffusion of sediment into the upper water column and
the scour hole at the rigid-bed transition.
