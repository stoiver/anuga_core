...
(0.038). The gate, which the paper shows opening over about 0.1~s from
the bottom, and the contraction from the 81~cm reservoir into the 24~cm
flume are the parts of the hydrodynamics to look at before the transport.
P1 runs routinely and P2 joins it under the long option.
