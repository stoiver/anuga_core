...
pyplot.subplot(222)
pyplot.scatter(xx[1],p2.vel[tindex,xx[0]],color='blue',label='model')
pyplot.scatter(xx[1],fvel(xx[1]),color='green',label='data')
pyplot.legend(loc='upper left')
#pyplot.xlim(0,25)
pyplot.title('Final flow speed along the transect')

pyplot.subplot(224)
pyplot.scatter(xx[1],p2.stage[tindex,xx[0]]-p2.elev[xx[0]],color='blue',label='model')
pyplot.scatter(xx[1],fdepth(xx[1]),color='green',label='data')
pyplot.legend(loc='upper left')
#pyplot.xlim(0,25)
