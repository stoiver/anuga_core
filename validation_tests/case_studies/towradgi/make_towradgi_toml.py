#!/usr/bin/env python3
"""
Generate a faithful anuga_run_toml config (towradgi.toml) that reproduces
...
def main():
    ...
    A = L.append
    A('# =============================================================================')
    A('# Towradgi Creek storm — anuga_run_toml equivalent of run_small_towradgi.py')
    A('# GENERATED by make_towradgi_toml.py — edit that script, not this file.')
    A('# Run:  anuga_run_toml towradgi.toml   (needs the DEM_bridges/Model/Forcing data)')
    A('# =============================================================================')
    A('')
    A('[project]')
