...
from .parallel_meshes import parallel_rectangular_domain
from .parallel_meshes import parallel_rectangular_cross_domain
from .parallel_meshes import parallel_rectangular_with_neighbours
from .parallel_meshes import parallel_rectangular_cross_with_neighbours

if pypar_available:
    from .parallel_meshes import parallel_rectangle
    from .parallel_meshes import parallel_rectangular_cross
    ...
    from anuga import rectangular_cross as parallel_rectangular_cross
