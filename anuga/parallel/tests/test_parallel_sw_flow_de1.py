"""
Simple water flow example using ANUGA  (DE1 flow algorithm)

Water driven up a linear slope and time varying boundary,
similar to a beach environment.

Tests that the parallel DE1 evolve produces the same gauge-station
...
class Test_parallel_sw_flow_de1(unittest.TestCase):
    def test_parallel_sw_flow_de1(self):
