...
class Test_Sww2Array(unittest.TestCase):
    def setUp(self):
        import time
        from anuga.abstract_2d_finite_volumes.mesh_factory import rectangular
...
#       self.verbose = False
    ...
    def test_sww2array_asc_elevation_depth(self):
        ...
        elev = sww2array(self.domain.get_name() + '.sww',
                quantity='elevation',
                cellsize=cellsize,
                verbose=self.verbose)


        ncols, nrows = elev.shape
...
"""
        ...
        depth = sww2array(self.domain.get_name() + '.sww',
                ascfile,
                quantity='depth',
                cellsize=cellsize,
                verbose=self.verbose)
